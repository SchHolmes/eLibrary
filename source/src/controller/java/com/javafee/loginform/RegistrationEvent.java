...
public class RegistrationEvent {
	...
	public enum RegistrationFailureCause {
		ALREADY_REGISTERED, PARAMETERS_ERROR, WEAK_PASSWORD, UNIDENTIFIED
	}
	...
	public static RegistrationEvent getInstance(String peselNumber, String documentNumber, String name, String surname,
			String address, City city, Character sex, Date birthDate, String login, String password, com.javafee.common.Constants.Role role) throws RefusedRegistrationException {
	...
	private static boolean checkRegistration(String login, String password, String peselNumber, com.javafee.common.Constants.Role role) {
	...
	private static UserData createUser(String peselNumber, String documentNumber, String name, String surname,
			String address, City city, Character sex, Date birthDate, String login, String password, com.javafee.common.Constants.Role role) {
