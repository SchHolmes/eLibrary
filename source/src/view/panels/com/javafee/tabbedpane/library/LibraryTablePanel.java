...
public class LibraryTablePanel extends JPanel {
	...
	public LibraryTablePanel() {
		...
		panelLoan.setBorder(new TitledBorder(null, "Loan", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panelReadingRoom.setBorder(new TitledBorder(null, "Reading room", TitledBorder.LEADING, TitledBorder.TOP, null, null));
