package com.javafee.tabbedpane.admdictionaries;
...
public class AdmDictionaryPanel extends JPanel {
	...
	public AdmDictionaryPanel() {
		...
		JLabel lblPublishingHouseName = new JLabel("Name:");
		...
		JLabel lblAuthorNickname = new JLabel("Nick:");
		...
		JLabel lblAuthorSurname = new JLabel("Surname:");
		...
		JLabel lblAuthorBirthDate = new JLabel("Birth date:");
