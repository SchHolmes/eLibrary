...
public class DecisionPanel extends JPanel {
	...
	public DecisionPanel() {
		...
		btnAccept.setIcon(new ImageIcon(new ImageIcon(LogInForm.class.getResource("/images/btnAccept-ico.png")).getImage().getScaledInstance(18, 18, Image.SCALE_SMOOTH)));
