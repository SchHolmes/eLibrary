...
public class AddMultiPanel extends JPanel {
	...
	public AddMultiPanel() {
		...
		btnAddToList.setIcon(new ImageIcon(new ImageIcon(LogInForm.class.getResource("/images/btnAddToList-ico.png"))
		...
		btnRemoveFromList
				.setIcon(new ImageIcon(new ImageIcon(LogInForm.class.getResource("/images/btnRemoveFromList-ico.png"))
						.getImage().getScaledInstance(18, 18, Image.SCALE_SMOOTH)));
		...
		btnCheckList.setIcon(new ImageIcon(new ImageIcon(LogInForm.class.getResource("/images/btnCheckList-ico.png"))
				.getImage().getScaledInstance(18, 18, Image.SCALE_SMOOTH)));
