...
public class MainSplashScreen extends JWindow {
	private static final long serialVersionUID = 1L;

	private static MainSplashScreen mainSplashScreen;

	private MainSplashScreen(String filename, final LogInForm f, int waitTime) {
		super();
	...
	public static MainSplashScreen getInstance(String filename, final LogInForm f, int waitTime) {
